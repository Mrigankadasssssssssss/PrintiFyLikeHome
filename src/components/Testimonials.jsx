        ...
        <div className="relative">
          ...
          >
            <div className="max-w-3xl mx-auto text-center text-2xl leading-9 font-medium text-gray-900">
              <p>&ldquo;This platform has completely transformed how I run my online business. The ease of creating and selling custom products is unmatched.&rdquo;</p>
            </div>
            <footer className="mt-8">
              <div className="md:flex md:items-center md:justify-center">
                ...
                <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                  ...
                  <div className="text-base font-medium text-gray-500">Entrepreneur</div>
                </div>
              </div>
            </footer>
          </motion.blockquote>
